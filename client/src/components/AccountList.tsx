    ...
    if(accounts.length === 0) {
        return (
            ...
            flex flex-col items-center justify-center py-20 px-6'>
                ...
                <p className='text-slate-700 text-lg'>No connected accounts</p>
                <p className='text-slate-400 text-sm mt-1 max-w-xs text-center'>Connect your first social platform to start scheduling posts.</p>
            </div>
        )
    }
    return(
                ...
                return (
                    ...
                    transition-all'>
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className='text-sm txt-slate-500 mt-0.5'>{meta.name}</div>
                        </div>

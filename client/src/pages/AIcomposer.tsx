...
const AIcomposer = () => {
    ...
    return (
        <div className='max-w-4xl mx-auto space-y-12 pb-20 animate-in fade-in duration-700'>
            ...
            <h1 className='text-3xl text-slate-700 tracking-tight'>What would you like to create today?</h1>
            ...
            <div className='space-y-6 pt-12 border-t border-slate-100'>
                <div className='flex items-center justify-between text-slate-600'>
                    ...
                    bg-slate-50 px-2">{generations.length} total</span>
                </div>
                    ...
                    {generations.map((gen) => (
                        ...
                        overflow-hidden'>
                            <div className='flex flex-col h-full space-y-4'>
                                ...
                                flex-1'>{gen.content}</p>

                                {gen.mediaUrl && (
                                    <div className='rounded-xl overflow-hidden border border-slate-50
                                    bg-slate-50'>
                                        <img src={gen.mediaUrl} alt="Generated media" className="w-full aspect-video
...

                    {
                        generations.length === 0 && (
                            <div className='col-span-full py-20 text-center space-y-2'>
                                ...
                                <p className="text-slate-400 text-sm">No Content generated yet. Try to generate some content using the AI composer.</p>
                            </div>
                        )
                    }
                </div>
                    ...
                    border-slate-100 overflow-hidden flex flex-col max-h-[90vh]'>
                        ...
                        <div className='flex-1 overflow-y-auto p-8 space-y-4'>
                            ...
                            space-y-4'>
                                ...
                                alt="Generated Media" className='w-full aspect-video object-cover rounded-xl border
